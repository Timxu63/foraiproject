...
SCHEMA_FILE_BY_ID = {
    ...
    "skill-metrics/v1": "skill-metrics.v1.schema.json",
    "skill-proposal/v1": "skill-proposal.v1.schema.json",
    "skill-config/v1": "skill-config.v1.schema.json",
    "skill-adoption-stage/v1": "skill-adoption-stage.v1.schema.json",
    "skill-proposal-decisions/v1": "skill-proposal-decisions.v1.schema.json",
